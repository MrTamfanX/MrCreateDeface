...
bgimage = raw_input("Masukan Link Background JPG/PNG/GIF (background): ")
message = raw_input("Masukan Pesan...Gunakan Kode <br> untuk text selanjutnya! : ")
textcolor = raw_input("Warna text (contoh=white): ")
youtubeid = raw_input("Masukan Lagu Youtube Kode (MUSIK): ")
